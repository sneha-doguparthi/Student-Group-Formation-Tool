...
public class StoreMcqOptionServiceTest {
	StoreMcqOptionService storeMcqOptionService = mock(StoreMcqOptionServiceImpl.class);
	ArrayList<Answer> answerList = new ArrayList<>();
	int questionId = 123;

	public StoreMcqOptionServiceTest() {
