...
public class SplitMcqAnswerServiceTest {
	SplitMcqAnswerService splitMcqAnswerService = mock(SplitMcqAnswerServiceImpl.class);
	ArrayList<Answer> answerList = new ArrayList<>();
	Answer answer = new Answer();
	int questionId = 123;

	public SplitMcqAnswerServiceTest() {
		Answer answer = new Answer();
