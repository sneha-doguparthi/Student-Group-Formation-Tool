...
public class CreateDatabaseConnectionTest {
	...
	private static Logger logger = LogManager.getLogger(CreateDatabaseConnectionTest.class);

	private static void setDatabaseConfigurations() {
		try {
			applicationConfigFile = "application.properties";
			applicationPropertiesStream = CreateDatabaseConnectionTest.class.getClassLoader()
			...
			activeDbPropertiesStream = CreateDatabaseConnectionTest.class.getClassLoader().getResourceAsStream(activeDb);
